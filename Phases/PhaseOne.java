...
public class PhaseOne {
    public static void main(String... args) {
        ...
        for (int index = 0; index < args.length; ++index) {
            ...
            if (args[index].equals("--convergence-num") || args[index].equals("-v"))
                numConvergences = Integer.parseInt(args[++index]);
        ...
        // display help
        if (help) {
            PhaseLib.printHelp(System.out, populationSize, numOffspring, radioactivity, generationCap);
        }
        else {
            // read genes
            ...
            Genome mostFit = PhaseLib.evolve(KnapsackGenome.builder, populationSize, numOffspring, 
                                             radioactivity, social, oneChild, decider);
