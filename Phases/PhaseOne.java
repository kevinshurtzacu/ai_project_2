...
public class PhaseOne {
    public static void main(String... args) {
        ...
        if (help) {
            ...
            System.out.println(" -s, --social           combine genomes at random, rather than combining genomes of comparable fitness");
            ...
            System.out.println(" cat inputfile.csv | java PhaseOne -s       combines genomes at random\n");
        }
        else {
            // read items
            ...
            Genome mostFit = PhaseLib.evolve(items, capacity, populationSize, numOffspring, radioactivity, 
                                             social, PhaseLib.convergeValue);
